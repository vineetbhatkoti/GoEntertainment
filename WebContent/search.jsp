...
<center><b>Welcome To GoEntertainment !! <b></b></center>

 MemberId : <h:outputText value="#{loginBean.memberid}"></h:outputText>
...
<c:set target="${searchSongBean}" property="memberid" value="${loginBean.memberid}"/>  
<c:set target="${searchMovieBean}" property="memberid" value="${loginBean.memberid}"/>
...
<h:selectOneMenu  id="select_sm1" value="#{loginBean.branchid}" onchange="submit()" immediate="true">
    ...
    <c:set target="${searchSongBean}" property="branchid" value="${loginBean.branchid}"/>
    <c:set target="${searchMovieBean}" property="branchid" value="${loginBean.branchid}"/>
    </h:form>
    <h:form>
